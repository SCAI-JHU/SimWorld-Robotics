...
class CityVisualizer(QMainWindow):
    ...
    def __init__(self, output_dir = "output"):
        ...
        self.city = CityData()
        self.city.load_from_files(output_dir=output_dir)
...
def main(output_dir = "output_test"):
    """Main function"""
    app = QApplication([])
    app.setStyle("Fusion")

    visualizer = CityVisualizer(output_dir=output_dir)
    visualizer.show()
